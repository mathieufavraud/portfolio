...
const about = () => {
    return (
        <section id="about">
            ...
            <p>De plus je dispose d&apos;une experience dans l&apos;assurance qualité en developpement web et en auto entreprenariat, ce qui m&apos;offre des competences supplémentaires pour être le plus polyvalent possible.</p>
