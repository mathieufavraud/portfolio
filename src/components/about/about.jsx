...
const about = () => {
    return (
        <section id="about" className="section_title_right">
            ...
            <p>Une carrière dans le support informatique et ma passion pour tous les aspects techniques de mon métier m&apos;ont conduit à m&apos;intéresser au domaine du développement web.</p>
            ...
            <div><Link to="/cv">< PiMagnifyingGlassBold /> Mon CV</Link></div>
        </section>
    );
};
